...
The `specl-lsp` binary provides IDE support via the Language Server Protocol (41 unit tests):
...
- **Document links**: Clickable URLs in comments (http/https links)
- **Semantic tokens**: Syntax highlighting (keywords, types, variables, functions, etc.)
- **Diagnostics**: Parse and type errors shown inline (push and pull modes)

## Examples

See `specl/examples/showcase/` (100 curated protocol specs — Raft, Paxos, EPaxos, CometBFT, Percolator, MESI, PBFT, SWIM, Narwhal-Tusk, Simplex, Redlock, Chandy-Lamport, G-Counter CRDT, PN-Counter CRDT, OR-Set CRDT, LWW Register, CRDT Flag, Vector Clocks, Lamport Clocks, Peterson, Dekker, Token Ring, Dining Philosophers, Chandy-Misra, Bakery, Reader-Writer, RW Write Preference, Leader Election, ABD Register, CAS Register, Lamport Mutex, Ricart-Agrawala, Maekawa Mutex, Ticket Lock, Test-and-Set, MCS Lock, CLH Lock, Byzantine Generals, RCU, Seqlock, Barrier, Two-Phase Locking, Two-Phase Commit, Three-Phase Commit, Wound-Wait, Bounded Buffer, WAL, Group Commit, Michael-Scott Queue, Treiber Stack, Work-Stealing Deque, Snapshot Isolation, MVCC, Timestamp Ordering, Hazard Pointers, Epoch Reclamation, ABA Problem, Sleeping Barber, Dining Savages, Cigarette Smokers, Priority Inversion, Double-Checked Locking, Crash Consensus, Token Bucket, Circuit Breaker, Exponential Backoff, Gossip Protocol, Map-Reduce, Reactor, Lease, Chain Replication, Primary-Backup, Causal Broadcast, FIFO Broadcast, Reliable Broadcast, OCC, STM, Termination Detection, Flat Combining, Cristian Clock Sync, Berkeley Clock Sync, Weighted Voting, Bully Election, MOESI, Flexible Paxos, Consistent Hashing, Rendezvous Hashing, Saga, Sloppy Quorum, Anti-Entropy, Read Repair, Phi Accrual, Log Replication, SWIM Protocol, Optimistic Replication, Split-Brain Resolver, Resource Allocator, Monotonic Counter, Two Generals, etc.) and `specl/examples/other/` (additional specs, semaphore puzzles, stress tests).
